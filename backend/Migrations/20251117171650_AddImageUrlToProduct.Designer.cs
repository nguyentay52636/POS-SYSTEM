...
namespace backend.Migrations
{
    ...
    [Migration("20251117171650_AddImageUrlToProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.ImportItem", b =>
                {
                    ...
                    b.HasKey("ImportItemId")
                        .HasName("PK__import_i__68BACFC3BC462D28");

                    b.HasIndex("ImportId");

                    b.HasIndex("ProductId");

                    b.ToTable("import_items", (string)null);
                });

            modelBuilder.Entity("backend.Models.ImportReceipt", b =>
                {
                    b.Property<int>("ImportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("ImportId")
                        .HasName("PK__import_r__F3E6B05FC1EBD501");
            ...
            modelBuilder.Entity("backend.Models.ImportItem", b =>
                {
                    b.HasOne("backend.Models.ImportReceipt", "Import")
