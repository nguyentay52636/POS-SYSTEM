...
public class InventoryController : ControllerBase
{
    ...
    /// </summary>
    /// <param name="dto">Dữ liệu cho bản ghi tồn kho mới (ProductId và Quantity)</param>
    ...
    public async Task<ActionResult<InventoryResponseDto>> Create([FromBody] CreateInventoryDto dto)
    {
        ...
        try
        {
            ...
            // Trả về 201 Created (chuẩn cho POST)
            // Kèm link tới tài nguyên vừa tạo (dùng hàm GetByProductId)
            return CreatedAtAction(
                nameof(GetByProductId), 
                new { productId = newInventory.ProductId }, // Dùng ProductId từ kết quả trả về
                newInventory);
        }
