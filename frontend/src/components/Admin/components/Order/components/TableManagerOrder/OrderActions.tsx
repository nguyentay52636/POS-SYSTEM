...
import { ArrowDownToLine, Search, ShoppingCart } from "lucide-react";
import type { UiStatus } from "../TableManagerOrder/TableManagerOrder";

interface OrderActionsProps {
  searchTerm: string;
  setSearchTerm: (value: string) => void;
  statusFilter: UiStatus;
  setStatusFilter: (value: UiStatus) => void; // <- prop của bạn vẫn là UiStatus
  exportBill: () => void;
}
